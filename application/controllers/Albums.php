...
class Albums extends CI_Controller {//Albums
	...
	public function album($param='null',$id='null') {
        ...
        elseif(isset($param) && $param=="edit" && is_numeric($id)) {  
          ...
          $this->load->view('index-old', $data_content);
        }
        ...
        if (!$this->upload->do_upload()) {
            ...
            foreach ($existingFiles as $fileName => $info) {
              if($fileName!='thumbs'){//Skip over thumbs directory
                ...
                $foundFiles[$f]['deleteUrl'] = base_url() . 'index.php/albums/deleteImage/' . $fileName;
            ...
            $info->deleteUrl = base_url() . 'index.php/albums/deleteImage/' . $data['file_name'];
