            ...
            <article class="col-xs-12 col-sm-6 col-md-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer">
                        <h4><a href="<?php echo base_url().'index.php/album/'.$value->id?>" title="<?php echo $value->title?>"><?php echo $value->title?></a></h4>
                        <span style="float: right">
                            <a class="btn btn-default btn-xs" href="<?php echo base_url().'index.php/album/edit/'.$value->id?>" aria-label="Edit">
                              <i class="glyphicon glyphicon-pencil" aria-hidden="true"></i>
                            </a>
                            <a class="btn btn-danger btn-xs" href="<?php echo base_url().'index.php/album/deactivate/'.$value->id?>" aria-label="Delete">
